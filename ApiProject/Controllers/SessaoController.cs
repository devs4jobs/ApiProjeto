...
//        [ProducesResponseType(202, Type = typeof(Sessao))]
//        [ProducesResponseType(400)]
//        [ProducesResponseType(401)]

//        public async Task<IActionResult> Put(string id, [FromBody] Sessao sessao)
//        {

//            var atualiza = new SessaoCore().AtualizarSessaoId(sessao, id);
//            if (atualiza.Status)
